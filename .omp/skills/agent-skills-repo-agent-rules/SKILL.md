---
name: agent-skills-repo-agent-rules
description: AGENTS.md workflow rules for the agent-skills-repo project — mandatory skill invocation, intent-to-skill mapping, DEFINE/PLAN/BUILD/VERIFY/REVIEW/SHIP lifecycle mapping, and the skill/persona/slash-command orchestration model (personas never invoke other personas). Use when working inside the agent-skills-repo codebase or deciding which skill applies to a task.
---
